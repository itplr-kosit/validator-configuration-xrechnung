...
This release is compatible with XRechnung 3.0
...
* Split `src/test/instances` into `processing-valid` and `processing-error`
...
* generated `src/report.sch.xsl` from version control
...
* Scenarios for matching XRechnung CVD invoices
